...
import { ImportPreview, ImportedTransaction } from './components/ImportPreview';
...
export default function SettingsPage() {
    ...
    const [importData, setImportData] = useState<ImportedTransaction[] | null>(null);
    ...
    const handleConfirmImport = async (finalTransactions: ImportedTransaction[]) => {
        setLoading(true);
        try {
            const res = await fetch('/api/import', {
                method: 'PUT',
            ...
            <div className="max-w-3xl mx-auto px-6 space-y-8">
                ...
                <section className="bg-[#121217] border border-white/5 rounded-2xl p-6">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center text-2xl font-bold">{userInitials}</div>
                        <div>
                ...
                <section className="bg-[#121217] border border-white/5 rounded-2xl p-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button
                            ...
                            className="px-6 py-2 bg-green-600 hover:bg-green-500 rounded-lg text-white transition-colors flex items-center gap-2 text-sm font-bold shadow-lg shadow-green-900/20"
                        >
