...
interface InsightData {
    forecast: { nextValue: number; slope: number; confidence: number };
    anomalies: { type: string; score: number; details: string; transactionId: string }[];
    recurring: { description: string; nextPotentialDate: string; avgAmount: number; frequency: string }[];
    tips: string[];
    error?: string;
}
                ...
                >
                    ...
                    <div className="space-y-4">
                        {recurring.length === 0 ? (
                            ...
                            recurring.map((rec: InsightData['recurring'][0], i: number) => (
                ...
                >
                    ...
                    <div className="space-y-4">
                        {anomalies.length === 0 ? (
                            ...
                            anomalies.map((anom: InsightData['anomalies'][0], i: number) => (
