...
export async function PUT(request: Request) {
    ...
    try {
        ...
        const created = await prisma.transaction.createMany({
            data: transactions.map((t: { amount: string | number; description: string; date: string | Date; type: "INCOME" | "EXPENSE"; categoryId?: string | null }) => ({
                amount: parseFloat(t.amount.toString()), // Amount is usually absolute in import, but Type handles sign logic
